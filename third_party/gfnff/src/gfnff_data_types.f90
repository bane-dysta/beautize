...
! ══════════════════════════════════════════════════════════════════════════════
  ...
  type :: TGFFUserInput
    ...
    !> BEAUTIZE extension (2026-09-15): exact non-periodic host graph.
    !> Positive entries denote edges; magnitudes are retained, NOT substituted
    !> for GFN-FF's internally derived pi bond orders / force constants.
